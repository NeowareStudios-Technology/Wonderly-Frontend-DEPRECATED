			...
			if (fm.targetStatus[i] != "none" || fm.targetStatus[i] != "created")
			{
				...
				switch(fm.targetStatus[i])
				{
					...
					case "video":
						...
						{
							case 0:
								save.vId[0] = tom.videoPlayer1.GetComponent<HighQualityPlayback>().videoId;
								...
								break;
							case 1:
								save.vId[1] = tom.videoPlayer2.GetComponent<HighQualityPlayback>().videoId;
								...
								break;
							case 2:
								save.vId[2] = tom.videoPlayer3.GetComponent<HighQualityPlayback>().videoId;
								...
								break;
							case 3:
								save.vId[3] = tom.videoPlayer4.GetComponent<HighQualityPlayback>().videoId;
								...
								break;
							case 4:
								save.vId[4] = tom.videoPlayer5.GetComponent<HighQualityPlayback>().videoId;
